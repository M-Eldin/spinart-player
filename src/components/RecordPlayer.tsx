...
export const RecordPlayer = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-between bg-gradient-to-b from-zinc-900 to-black p-4 md:p-8">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                      <div className="relative mb-12">
                        ...
                        <div className="turntable-platter w-64 h-64 md:w-72 md:h-72 rounded-full shadow-record relative">
                          {/* Vinyl record */}
                          <motion.div 
                            className="absolute inset-0 rounded-full vinyl-grooves shadow-inner-dark"
                          ...
                          >
                            ...
                            {playerState.currentTrack ? (
                              <div className="absolute inset-0 flex items-center justify-center">
                                <div className="vinyl-label-edge w-24 h-24 md:w-32 md:h-32 rounded-full flex items-center justify-center">
                                  <img 
                                    src={playerState.currentTrack.album.images[0]?.url} 
                                    alt={playerState.currentTrack.album.name}
                                    className="w-20 h-20 md:w-28 md:h-28 rounded-full object-cover border-2 md:border-4 border-black/80"
                                  />
                                </div>
                              </div>
                            ) : (
                              <div className="absolute inset-0 flex items-center justify-center">
                                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-zinc-800 flex items-center justify-center">
